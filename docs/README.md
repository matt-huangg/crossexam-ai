...
- `persona-design.md` — detailed prompt/behavior design notes for the
  ...
  leading-question-resistance behavior.

**Reminder**: any example case file in this directory must be entirely
synthetic/hypothetical. See the "No real case data, ever" constraint in
`../README.md`.
